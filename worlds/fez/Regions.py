...
all_region_data: Set[FezRegionData] = {
    ...
    FezRegionData("Industrial City", {"Memory Core", "Nuzu School", "Nuzu Boileroom", "Nuzu Abandoned A", "Showers", "Nuzu Dormitory"}),
    FezRegionData("Industrial Hub", {"Industrial Superspin", "Rails", "Pivot 1", "Pivot Watertower", "Industrial Abandoned A", "Nuzu Abandoned B", "Well 2"}),
